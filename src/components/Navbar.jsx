...
const Header = () => {
  ...
  return (
    <header className={`px-[8vw] py-5 flex justify-between items-center ${!isOpen && "shadow-lg"}  flex-wrap`}>
      ...
      {/* Mobile nav */}
      <div className={`flex md:items-center md:gap-8 gap-5 max-md:w-full max-md:flex-col items-start max-md:absolute top-14 left-0 max-md:px-[8vw] max-md:shadow-lg overflow-hidden duration-300 ${isOpen?"max-md:h-[255px] max-md:pt-4":"max-md:h-0"}`}>
